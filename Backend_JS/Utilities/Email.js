...
module.exports = {
  sendEmail: class sendEmail {
    constructor(user, url) {
      ...
      this.date = user.date;
      this.acceptURL = `http://127.0.0.1:3333/App/Appointments`;
      this.declineURL = `http://127.0.0.1:3333/App/Appointments/Declined`;
      this.reScheduleURL = `http://127.0.0.1:3333/App/Appointments/Re-Schedule`;
      this.cancelURL = `http://127.0.0.1:3333/App/Appointments/Cancel`;
      if (user.message) {
    ...
    async _send(template, subject) {
      const html = pug.renderFile(`${__dirname}/../Views/Emails/${template}.pug`, {
        ...
        scheduleDate: Calendar.getLongDate(this.start, this.end),
