...
/* harmony import */ var _Message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Message */ "./Public/JS/Message.js");
...
const emailMe = async (firstName, lastName, organization, position, email, subject, message) => {
  try {
...
/* harmony export */ });
const showMessage = (type, message, statusCode) => {
      ...
      if (entry.target === allGrids[4]) {
        if (contactForm) {
          contactForm.addEventListener("submit", function (e) {
            ...
            console.log(firstName, lastName, organization, position, email, subject, message);
            (0,_Email__WEBPACK_IMPORTED_MODULE_2__.emailMe)(firstName, lastName, organization, position, email, subject, message);
          });
        }
      }
